        ...
        {cart.length === 0 ? (
          ...
          <>
            <Stack spacing={2} alignItems="center">
              {cart.map((cartPlant) => (
                <Card key={cartPlant.id} sx={{ maxWidth: 600, width: '100%', display: 'flex', alignItems: 'center', padding: '10px', position: 'relative' }}>
                  {cartPlant.photo && (
                    <CardMedia
                      component="img"
                      sx={{ width: 120, height: 120, objectFit: 'cover', borderRadius: '8px', marginRight: '16px' }}
